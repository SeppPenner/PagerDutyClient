//--------------------------------------------------------------------------------------------------------------------
// <copyright file="DtoIncidentRespondersResult.cs" company="Hämmer Electronics">
//   Copyright (c) All rights reserved.
// </copyright>
// <summary>
//   A base class to transfer the incidents responders result objects from the PagerDuty API.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
[JsonSchemaFlatten]
[Serializable]
public class DtoIncidentRespondersResult
{
    /// <summary>
